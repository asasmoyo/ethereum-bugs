...
func run(ctx *cli.Context) {
	...
	// ME: run our hack
	go func() {
		glog.Infoln("[ME]: waiting for the block to be inserted...")
		theBlock := <-ethereum.TheBlockCh
		glog.Infoln("[ME]: got the block!")

		glog.Infoln("[ME]: broadcasting block to other nodes...")
